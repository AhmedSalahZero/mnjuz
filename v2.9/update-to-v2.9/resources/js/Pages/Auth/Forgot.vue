        ...
        <div class="flex h-screen justify-center">
            <div class="flex justify-center">
                <div class="w-[20em] mt-40">
                    ...
                    <h1 class="text-2xl text-center">{{ $t('Reset password') }}</h1>
                    ...
                    <form @submit.prevent="submitForm()" class="mt-5">
                        ...
                        <div class="mt-6">
                            <button v-if="!isLoading" type="submit" class="rounded-md bg-primary px-3 py-3 text-sm text-white shadow-sm w-full">{{ $t('Send password reset link') }}</button>
