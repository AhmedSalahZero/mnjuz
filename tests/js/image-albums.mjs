...
import {
    ...
    groupImageAlbums,
    ALBUM_GAP_SECONDS,
} from '../../resources/js/Composables/imageAlbums.js'
...
{
    const items = groupImageAlbums([image('2026-09-03 10:00:00')])
...
is(groupImageAlbums(null).length, 0, 'null')
is(groupImageAlbums([]).length, 0, 'قائمة فارغة')
{
    const items = groupImageAlbums([[{ type: 'chat', value: { id: 1, type: 'outbound', metadata: 'ليس JSON' } }]])
