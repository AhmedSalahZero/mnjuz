...
const metadata =
  props.contact.metadata !== null && props.contact.metadata !== ''
...
<template>
  <div class="px-20 overflow-y-scroll h-screen">
    <div class="flex justify-center space-x-8 items-center pb-6 pr-20 border-gray-300 border-b">
      ...
      <div>
        ...
        <div class="flex space-x-3 mt-4">
          ...
          <button
            @click="favorite()"
            class="bg-gray-200 h-9 px-4 rounded-md">
            <svg
              v-if="contact.is_favorite === 0 || contact.is_favorite === false"
              xmlns="http://www.w3.org/2000/svg"
              width="20"
              height="20"
              viewBox="0 0 24 24">
            ...
            <button class="h-9 bg-gray-200 py-2 px-3 rounded-md flex items-center">
              <span class="">
                <svg
                  ...
                  <path
                    fill="currentColor"
                    d="M4 8a2 2 0 1 1-4 0a2 2 0 0 1 4 0Zm6 0a2 2 0 1 1-4 0a2 2 0 0 1 4 0Zm4 2a2 2 0 1 0 0-4a2 2 0 0 0 0 4Z" />
                </svg>
              </span>
            </button>
            <template #items>
    ...
    <div
      ...
      class="pr-20 border-gray-300 border-b py-4">
      <div
        v-for="(input, index) in props.fields"
        :key="index"
        class="grid grid-cols-2 space-x-8 text-[14px]">
        <div class="text-right text-slate-500 pb-2">
        ...
        <div>
          ...
          <span
            v-else
            class="p-1 bg-slate-100 text-xs rounded-md text-gray-600"
            >{{ $t('not set') }}</span
          >
        </div>
      </div>
    ...
    <div
      ...
      class="pr-20 border-gray-300 border-t py-4">
      <div
        v-for="(input, index) in props.fields"
        class="grid grid-cols-2 space-x-8 text-[14px]">
        <div class="text-right text-slate-500 pb-2">
