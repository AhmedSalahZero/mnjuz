        ...
        <div v-else>
            <Listbox 
                ...
                <div class="relative">
                    ...
                    <ListboxOptions
                        :class="[
                            'z-10 absolute max-h-80 w-full overflow-auto rounded-md bg-white py-1 text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm',
