  ...
  <div class="normal-case">
    <div>
      ...
      <div class="flex items-center justify-between mt-2 mb-2">
        <span class="text-xs"
          >{{ $t('Characters') }}: {{ characterCount + '/' + characterLimit }}</span
        >
        <div class="flex items-center space-x-3">
          <button
            type="button"
            @click="addVariable"
            class="hover:bg-slate-100 rounded p-1 text-sm cursor-pointer"
            :disabled="variableButtonDisabled">
            {{ $t('Add variable') }} ({{ $t('Max: 1') }})
          </button>
        </div>
      </div>
    </div>
    <div
      ...
      <div class="mb-4">
        ...
        <p class="text-xs">
          {{
            $t(
              'Please add an example for each variable in your body text. Do not use real customer information. Cloud API hosted by Meta reviews templates and variable parameters to protect the security and integrity of their services.',
            )
          }}
        </p>
      </div>
      ...
      <div
        v-if="isCustomValuesIncomplete"
        class="p-2 bg-red-100 rounded-md flex items-center gap-x-2 mt-4">
        <svg
          class="text-red-800"
          ...
          <path
            fill="currentColor"
            d="M13 9a1 1 0 1 1-2 0a1 1 0 0 1 2 0m-1 2.75a.75.75 0 0 1 .75.75v5a.75.75 0 1 1-1.5 0v-5a.75.75 0 0 1 .75-.75" />
          <path
            fill="currentColor"
            fill-rule="evenodd"
            d="M14.27 3.993a2.749 2.749 0 0 0-4.54 0l-.432.632a75.95 75.95 0 0 0-6.944 12.563l-.09.208a2.511 2.511 0 0 0 2.024 3.497a69.43 69.43 0 0 0 15.424 0a2.511 2.511 0 0 0 2.024-3.497l-.09-.208a75.951 75.951 0 0 0-6.944-12.563zm-3.302.846a1.25 1.25 0 0 1 2.064 0l.432.632a74.444 74.444 0 0 1 6.806 12.315l.09.208a1.011 1.011 0 0 1-.814 1.408c-5.015.56-10.077.56-15.092 0a1.011 1.011 0 0 1-.815-1.408l.09-.208a74.45 74.45 0 0 1 6.807-12.315z"
            clip-rule="evenodd" />
        </svg>
