<template>
	<div class="flex flex-col h-full overflow-hidden">
		...
		<div class="mt-auto flex-shrink-0">
			...
			<div
				class="flex items-center m-3 p-2 rounded-xl h-14 py-1 md:py-1 mt-2 space-x-4 justify-between bg-slate-50">
				<div class="flex space-x-2">
					...
					<div>
						<h2 class="text-[15px] capitalize truncate w-[6em]">{{ user.first_name + ' ' + user.last_name }}
						</h2>
	...
	<ProfileModal :user="props.user" :organization="{}" :isOpen="isOpen" role="admin" :languages="languages"
		@close="closeModal()" />
</template>
<script setup>
