      ...
      <div class="md:flex md:flex-grow-1">
        <div class="md:w-[50%] py-4 md:p-8 overflow-y-auto md:h-[90vh]">
          ...
          <div v-if="form.category === 'UTILITY' || form.category === 'MARKETING'">
            ...
            <div class="mb-8">
              <div>
                <BodyTextArea
                  ...
                  :customValues="form.body.example"
            ...
            <h2 class="text-slate-600 capitalize">
              ...
              <div class="mt-4">
                <div class="relative flex mb-2">
                  ...
                  <div
                    class="text-sm leading-6 cursor-pointer"
                    @click="
                      form.body.add_security_recommendation = !form.body.add_security_recommendation
                    ">
                    <label
                      :for="name"
        ...
        <div
          class="md:w-[50%] py-20 px-20 h-[100vh] overflow-y-auto"
          ...
          <div
            ...
            <h2
              v-else-if="form.header.format == 'TEXT' && form.category != 'AUTHENTICATION'"
              class="text-gray-700 text-[16px] mb-1 px-2">
              {{ form.header.text }}
            </h2>
            <p
          ...
          <div
            v-if="form.category != 'AUTHENTICATION' && form?.buttons?.length > 0"
            class="mr-auto text-sm text-[#00a5f4] flex flex-col relative max-w-[25em]">
            <div
...
const extractButtonParam = (key) => {
  const buttonsComponent = metadata.value.components.find(
...
const isFormValid = computed(() => {
  if (
    ...
    (Array.isArray(form.value.buttons) &&
