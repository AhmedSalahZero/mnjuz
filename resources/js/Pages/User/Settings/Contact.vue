							...
							<div class="flex w-full">
								<div class="text-md">
									...
									<div class="mb-1 text-slate-500">
										{{ $t('Place custom fields before or after the address section') }}</div>
								</div>
								<div class="ml-auto">
							...
							<div class="flex w-full mb-4">
								...
								<div class="ml-auto">
									<button @click="openModal()"
										class="float-right rounded-md bg-primary px-3 py-2 text-sm text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">{{ $t('Add fields') }}</button>
								</div>
							</div>
							<div class="w-5/5">
								<!-- Table Component-->
