            ...
            <div class="flex mt-4">
                <div class="md:w-1/5 bg-white border border-slate-200 h-[fit-content] rounded-lg pb-10 md:block hidden">
                    <ul class="pt-2 space-y-1 text-sm mb-2 px-2">
                        ...
                        <li v-if="!isOrgAgent" class="hover:bg-slate-50 hover:text-black rounded-[5px] px-1 truncate cursor-pointer" :class="$page.url.startsWith('/settings/whatsapp') ? 'bg-slate-50 text-black' : ''">
                        ...
                        <li v-if="!isOrgAgent" class="hover:bg-slate-50 hover:text-black rounded-[5px] px-1 truncate cursor-pointer" :class="$page.url.startsWith('/settings/contacts') ? 'bg-slate-50 text-black' : ''">
                        ...
                        <li v-if="!isOrgAgent && $page.props.organization?.plan?.features?.ice_breakers" class="hover:bg-slate-50 hover:text-black rounded-[5px] px-1 truncate cursor-pointer" :class="$page.url.startsWith('/settings/conversations') ? 'bg-slate-50 text-black' : ''">
                        ...
                        <li v-if="!isOrgAgent" class="hover:bg-slate-50 hover:text-black rounded-[5px] px-1 truncate cursor-pointer" :class="$page.url.startsWith('/settings/tickets') ? 'bg-slate-50 text-black' : ''">
                        ...
                        <li v-if="!isOrgAgent && (moduleActive('AI Assistant') || moduleActive('Flow builder'))" class="hover:bg-slate-50 hover:text-black rounded-[5px] px-1 truncate cursor-pointer" :class="$page.url.startsWith('/settings/automation') ? 'bg-slate-50 text-black' : ''">
                        ...
                        <li v-if="!isOrgAgent" class="hover:bg-slate-50 hover:text-black rounded-[5px] px-1 truncate cursor-pointer" :class="$page.url.startsWith('/settings/plugins') ? 'bg-slate-50 text-black' : ''">
                        ...
                        <li v-if="!isOrgAgent && $page.props.settingsModuleWorkingHours" class="hover:bg-slate-50 hover:text-black rounded-[5px] px-1 truncate cursor-pointer" :class="$page.url.startsWith('/settings/working-hours') ? 'bg-slate-50 text-black' : ''">
...
<script setup>
    ...
    const orgRole = computed(() => usePage().props.auth?.user?.organization_team_role ?? '')
