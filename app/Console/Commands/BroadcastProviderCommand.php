...
class BroadcastProviderCommand extends Command
{
    ...
    private function switchTo(string $target): int
    {
        ...
        // الويب و الطوابير يقرآن الإعداد من القاعدة، لكن عامل الطابور عملية
        // طويلة العمر تحتفظ بالقراءة الأولى — فيبقى على المزوّد القديم حتى
        // يُعاد تشغيله. هذا نصف تبديل: الداشبورد ينتقل والرسائل الخلفية لا.
        $this->warn('  شغّل <options=bold>php artisan queue:restart</> ليلتقط عمّال الطابور المزوّد الجديد.');
