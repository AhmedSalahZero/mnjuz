...
class UserDeviceService
{
    ...
    public function registerOrTouch(User $user, array $deviceData, string $category = null): UserDevice
    {
        ...
        // الفئتان تتعايشان: الداشبورد على الحاسب والتطبيق على الجوال معاً.
        //
        // كان أيّ دخول يطرد الفئة الأخرى — دخولٌ على اللوحة يُبطل رموز الجوال
        // ودخولٌ على التطبيق يُنهي جلسة المتصفّح. أُلغي بطلب العميل: الموظّف
        // يحتاج الاثنين في آنٍ واحد، والتأرجح بينهما مع كل دخول عائقٌ لا حماية.
        //
        // ويبقى «جهاز واحد لكل فئة» قائماً: device_identifier يُجدَّد مع كل
        // تسجيل، فدخولٌ من متصفّح ثانٍ يُخرج الأوّل، وكذلك جوال ثانٍ.
