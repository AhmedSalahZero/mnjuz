...
if (file_exists(base_path('modules/EmbeddedSignup/Providers/EmbeddedSignupServiceProvider.php'))) {
...
if (file_exists(base_path('modules/IntelliReply/Providers/IntelliServiceProvider.php'))) {
    $providers[] = \Modules\IntelliReply\Providers\IntelliServiceProvider::class;
}

if (file_exists(base_path('modules/FlowBuilder/Providers/FlowBuilderServiceProvider.php'))) {
...
if (file_exists(base_path('modules/Pabbly/Providers/PabblyServiceProvider.php'))) {
    $providers[] = \Modules\Pabbly\Providers\PabblyServiceProvider::class;
}

if (file_exists(base_path('modules/Woocommerce/Providers/WoocommerceServiceProvider.php'))) {
